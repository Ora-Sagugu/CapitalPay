...
from .views import (
    NostroAccountViewSet, FundTransferViewSet, UserPaymentDetailViewSet,
    DepositRequestViewSet, VirtualAccountViewSet, AgentDisbursementViewSet,
)
...
router.register(r"disbursements", AgentDisbursementViewSet, basename="disbursement")
